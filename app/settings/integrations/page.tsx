      ...
      <div className="space-y-4">
        ...
        <div className="bg-white dark:bg-[#161B26] border border-black/[.07] dark:border-white/[.08] rounded-[14px] p-[20px]">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              <p className="text-[14px] font-medium text-[#0F1A2E] dark:text-[#E8E6E2]">Google Reviews</p>
              <p className="text-[12px] text-[#A09E98] mt-[1px]">Pacientes satisfeitos (nota ≥ 4) recebem o link pelo WhatsApp automaticamente.</p>
            </div>
          </div>

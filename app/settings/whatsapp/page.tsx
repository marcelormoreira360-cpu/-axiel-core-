    ...
    <Shell>
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-lg text-black/55">
          Configure o assistente de atendimento do WhatsApp para a sua clínica. O fluxo de 7 etapas é o padrão de referência — adapte os textos, preços e programa ao seu contexto.
        </p>
      </div>

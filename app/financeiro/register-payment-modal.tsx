    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-[#0F1A2E]">Registrar pagamento</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Paciente */}
          <div>
            <label className="mb-1 block text-sm font-medium text-[#0F1A2E]">Paciente *</label>
            <select
              name="patient_id"
          ...
          {/* Valor */}
          <div>
            <label className="mb-1 block text-sm font-medium text-[#0F1A2E]">Valor (R$) *</label>
          ...
          {/* Forma de pagamento */}
          <div>
            <label className="mb-1 block text-sm font-medium text-[#0F1A2E]">Forma de pagamento *</label>
            <div className="grid grid-cols-2 gap-2">
              {METHODS.map((m) => (
                ...
                >
                  <input type="radio" name="payment_method" value={m.value} required className="accent-[#0B1F3A]" />
                  {m.label}
                </label>
              ))}
            </div>
          ...
          {/* Data */}
          <div>
            <label className="mb-1 block text-sm font-medium text-[#0F1A2E]">Data do pagamento</label>
            <input
              name="paid_at"
              type="date"
          ...
          {/* Notas */}
          <div>
            <label className="mb-1 block text-sm font-medium text-[#0F1A2E]">Observações</label>
            <input
              name="notes"
              type="text"

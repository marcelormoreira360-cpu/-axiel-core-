      ...
      <Card className="max-w-2xl p-6">
        <form action={createPatientAction} className="grid gap-4">
          <label className="grid gap-2 text-sm font-semibold">Nome completo
            <input name="full_name" required className="min-h-14 rounded-2xl border border-axiel-line bg-white px-4 text-base outline-none focus:border-black/30" placeholder="Nome do paciente" />
          </label>

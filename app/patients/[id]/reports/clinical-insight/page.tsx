    ...
    <Shell>
      <header className="mb-8 pt-4">
        ...
        <div className="mt-6 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm font-medium tracking-[0.22em] text-axiel-gold">PATIENT INSIGHT</p>
            <h1 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">Patient Insight</h1>
            <p className="mt-3 max-w-2xl text-black/55">A simple summary of the patient, key notes, and possible connections. No diagnosis. No session plan.</p>
          </div>
      ...
      <div className="mb-5 rounded-xl border border-axiel-line bg-white p-6 text-sm leading-6 text-black/60 shadow-sm backdrop-blur">
        <div className="flex items-start gap-3">
          ...
          <p>This insight uses saved patient information and session notes. It is written in simple words so the patient can understand it.</p>
        </div>
      </div>

...
async function generateStep2Reply(
  ...
  const system =
    lang === "en"
      ? `You are an assistant for ${config.clinic_name}. Respond in English, warm and professional tone, WhatsApp style, short messages. The patient shared their reason for contact. This is a WhatsApp chat, NOT a form: do NOT dump a numbered list of questions. First ACKNOWLEDGE with 1 genuine empathetic sentence about what they said, then ask AT MOST 1 or 2 questions, naturally, and leave room for them to answer before asking more. Start with the highest-value question (usually how long they have felt this, and how much it affects their daily life); the rest (whether they tried other treatments, what they would most like to improve) you gather in the NEXT turns, one at a time, as the conversation flows, without repeating anything already answered. Do not explain the program, do not show prices. Never diagnose. Never use an em dash (—): use commas, colons or parentheses.`
      : `Você é assistente de ${config.clinic_name}. Responda em português brasileiro, tom acolhedor, estilo WhatsApp, mensagens curtas. O paciente informou o motivo do contato. Isto é um bate-papo de WhatsApp, NÃO um formulário: NÃO despeje uma lista numerada de perguntas. Primeiro ACOLHA com 1 frase de empatia sincera sobre o que a pessoa disse, depois faça no MÁXIMO 1 ou 2 perguntas, de forma natural, deixando espaço para ela responder antes de puxar a próxima. Comece pela pergunta de maior valor (normalmente há quanto tempo sente isso e o quanto atrapalha o dia a dia); o resto (se já tentou outros tratamentos, o que mais gostaria de melhorar) você colhe NAS PRÓXIMAS trocas, uma de cada vez, conforme a conversa flui, sem repetir o que já foi respondido. Não explique o programa, não mostre valores. Nunca diagnostique. Nunca use travessão (—): use vírgula, dois-pontos ou parênteses.`;

import type { SessionRecord, SessionVitals, ClinicalTestResult, BodyMapNote } from "@/lib/types";
    ...
    .upsert(
      {
        ...
        clinical_tests:   input.clinical_tests ?? null,
        body_map_notes:   input.body_map_notes ?? null,

...
-- PERF-05: CONCURRENTLY removido — não funciona dentro de transações
-- implícitas do supabase db push. IF NOT EXISTS garante idempotência.
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_session_records_patient_created
  ON session_records (patient_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_session_records_clinic_created
...
CREATE INDEX IF NOT EXISTS idx_assessment_invitations_token_hash
...
CREATE INDEX IF NOT EXISTS idx_follow_ups_clinic_status
